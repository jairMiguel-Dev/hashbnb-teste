...
const Header = () => {
  return (
      ...
      <div className='flex items-center justify-between px-8 py-4 max-w-7xl mx-auto'>
        ...
        <img src="https://cdn.prod.website-files.com/61b9e0dd381626819c8d4f83/65e2198d48039ba6444f602b_logo%20hashtag%20-%20h.webp" alt="Logo" />
        <p className='text-2xl text-primary-400'>ashbnb</p>
        </div>

        <div className='flex items-center border border-gray-300 pr-4 pl-6 py-2 rounded-full'>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
        ...
        <div><div className='flex items-center border border-gray-300 pr-4 pl-6 py-2 rounded-full gap-2'>
